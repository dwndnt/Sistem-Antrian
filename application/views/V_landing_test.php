...
<body class="landing-page sidebar-collapse">
  <nav class="navbar navbar-transparent navbar-color-on-scroll fixed-top navbar-expand-lg" color-on-scroll="100" id="sectionsNav">
    <div class="container">
      <div class="navbar-translate"><a class="navbar-brand" href="#"><img src="<?php echo base_url('assets/img/logo.png'); ?>')"></div>
      <div class="collapse navbar-collapse">
        <ul class="navbar-nav ml-auto"> </ul>
        <div class="collapse navbar-collapse">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url('DaftarDokter'); ?>"><i class="material-icons"></i>Dokter</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url('DaftarLayanan'); ?>"><i class="material-icons"></i>Layanan</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url('JadwalDokter'); ?>"><i class="material-icons"></i>Jadwal</a>
            </li>
          </ul>
        </div>
      </div>
  </nav>
  <div class="page-header header-filter" data-parallax="true" style="background-image: url('<?php echo base_url('assets/img/rsu_yosua.png'); ?>')">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12 text-center" style="margin-top: 40px;"><a href="<?php echo base_url('Daftar'); ?>" class="btn btn-danger btn-raised btn-lg">register</a></div>
      </div>
    </div>
  </div>
