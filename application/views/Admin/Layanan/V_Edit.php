				...
				<div class="col-md-12">
					<div class="panel">
						<div class="panel-body">
							...
							?>
							<div class="col-md-6">
								<input id="id" name="id" type="hidden" class="form-control" value="<?php echo $value['id_layanan']; ?>" >
								...
								<div class="form-group">
									...
									<input id="nama" maxlength="3" name="code_layanan" type="text" class="form-control" placeholder="Kode Layanan" value="<?php echo $value['code_layanan']; ?>" required="" style="width: 30%;">
								</div>
								<div class="form-group">
