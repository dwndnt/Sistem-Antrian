...
<head>
  ...
  <title>Registrasi Antrian Online</title>
  <link rel="apple-touch-icon" sizes="76x76" href="<?php echo base_url('assets/img/favicon_rsuyoshua.png'); ?>">
  <link rel="icon" type="image/png" sizes="96x96" href="<?php echo base_url('assets/img/favicon_rsuyoshua.png'); ?>">
